...
**Telegram-напоминания (ветка `telegram-notify`): Task 1-6 из 8 готовы и приняты, ждёт Task 7 (ручная
настройка бота+секретов пользователем).** Не влито в `main`. Детали — в логе сессий ниже.
