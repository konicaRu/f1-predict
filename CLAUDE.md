...
**`docs/constitution.md` — незыблемые принципы проекта** (безопасность RLS-first, UTC/МСК, cloud-direct, секреты, процесс с ревью-гейтами, YAGNI, дизайн). Сверяйся с ней в каждой спеке, плане и ревью. Детали — в `plan.md`; при смене правила сначала правим конституцию.
