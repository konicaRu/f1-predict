-- 0013_revoke_public_execute.sql — критический security-фикс. ПРИМЕНЕНО К БД 2026-07-22,
-- подтверждено регресс-тестом scripts/db/security_grants.test.js (6/6 PASS против прод-БД).
--
